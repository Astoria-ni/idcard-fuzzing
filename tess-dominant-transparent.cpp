		...
		do {
		  ...
		  */
		  ...
		  printf("word: '%s';  \tconf: %.2f; BoundingBox: %d,%d,%d,%d;\n",
			...
			if(cond) rectangle(overlay, Point(x1,y1), Point(x2,y2), Scalar(rr,gg,bb), FILLED, LINE_8); //draw color rect
			if(cond) putText(overlay, wordstring, Point(x1,y2), FONT_HERSHEY_DUPLEX, 1, Scalar(70,70,70), 2);
